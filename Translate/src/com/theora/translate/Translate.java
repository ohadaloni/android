...
public class Translate extends Activity {
   ...
   private void findViews() {
	  ...
	  origText.setText("The quick brown fox jumps over a lazy dog.");
   ...
   private void setAdapters() {
      ...
      /*	fromSpinner.setSelection(8); // en	*/
      /*	toSpinner.setSelection(11); // fr	*/
